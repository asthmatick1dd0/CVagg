  ...
  return (
    <section className="flex flex-col justify-center items-center rounded-4xl bg-primary/60 pt-10 pb-18 px-3 gap-12 min-w-sm">
        <section className="flex flex-row w-full items-center justify-between px-6">
          <Button variant="secondary" className="flex items-center justify-center h-12 w-12 rounded-full relative hover:cursor-pointer">
          ...
          <div className="flex gap-4">
            ...
            <Button variant="secondary" className="font-inter text-md font-semibold px-16 max-md:px-6 h-12 hover:cursor-pointer">Выделить</Button>
          </div>
        </section>
